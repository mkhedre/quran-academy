...
export function RegistrationForm() {
  ...
  function onSubmit(values: FormValues) {
    ...
    const academyNumber = '01050173227'; // Replace with actual academy number
    const message = `السلام عليكم ورحمة الله وبركاته،\n\nأرغب في الانضمام لأكاديمية قيم.\n\nالاسم: ${values.name}\nالهدف: ${values.goal}\n\nشكراً لكم.`;
          ...
          <div className="lg:w-2/5 bg-secondary p-12 text-primary flex flex-col justify-between">
            <div>
              ...
              <p className="text-lg opacity-80 leading-relaxed mb-8">
                خطوة واحدة تفصلك عن الانضمام لأكبر مجتمع لتحفيظ القرآن الكريم
                بنظام المكافآت.
              </p>
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <p className="font-medium">
                    سيتم توجيهك فوراً للمتابعة عبر الواتساب
                  </p>
                </div>
              </div>
            </div>
            ...
            <Form {...form}>
              ...
              >
                ...
                <p className="text-center text-sm text-white/50">
                  بضغطك على إرسال، سيتم حفظ بياناتك وتوجيهك للمحادثة الرسمية.
                </p>
              </form>
            </Form>
          </div>
