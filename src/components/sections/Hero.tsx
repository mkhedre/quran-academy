    ...
    <section className="relative pt-32 pb-20 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-headline font-bold text-primary leading-tight mb-6">
              تمكين الأرواح من خلال <br />
              <span className="text-secondary">القرآن والمكافآت</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-xl leading-relaxed">
              تعلم، احفظ، واحصل على مكافآت فورية لكل آية تحفظها. رحلتك مع كتاب الله أصبحت أكثر إلهاماً مع نظامنا الفريد.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-end">
              <Button size="lg" className="bg-secondary text-primary hover:bg-secondary/90 text-lg font-bold px-10 py-7 rounded-xl shadow-lg shadow-secondary/20">
                ابدأ رحلتك الآن
              </Button>
              <Button size="lg" variant="outline" className="border-primary text-primary hover:bg-primary/5 text-lg font-bold px-10 py-7 rounded-xl">
                اكتشف البرامج
              </Button>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-full max-w-[500px] aspect-square rounded-full flex items-center justify-center">
              ...
              <div className="relative z-10 w-[80%] aspect-square rounded-3xl overflow-hidden shadow-2xl rotate-3 border-4 border-white/50 animate-subtle-glow">
                <Image
                  src={heroImg?.imageUrl || "https://picsum.photos/600/600"}
              ...
              <div className="absolute -bottom-10 -right-10 bg-white p-6 rounded-2xl shadow-xl flex items-center gap-4 z-20 border border-secondary/20">
                ...
                <div>
                  ...
                  <p className="font-bold text-primary">50 ريال / 10 آيات</p>
                </div>
              </div>
            </div>
          </motion.div>
